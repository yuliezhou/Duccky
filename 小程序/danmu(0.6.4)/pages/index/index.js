...
Page({
    ...
    onShareAppMessage: function () {
        ...
        return {
            title: '快点开看我说了啥',
            desc: '让弹幕飞一会吧!',
            path: '/pages/index/index?id=' + input_val + '&bool_bodyeron=' + bool_bodyer + '&bool_homeon=' + bool_home + '&share_stron=' + share_str + '&share_numberon=' + share_number+'&shadowcoloron=' + share_colorstr,
